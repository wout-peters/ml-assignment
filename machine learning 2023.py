...
# oversample target value=1 classification to make data balanced
...
# est Parameters:  {'depth': 10, 'iterations': 3000, 'learning_rate': 0.05, 'loss_function': 'CrossEntropy'}
# Best Score:  0.877325608994807
# Out of sample accuracy  : 0.8347029819206386